package br.com.astrosoft.transferenciaBancaria.view.user
...
import br.com.astrosoft.transferenciaBancaria.view.user.UserCrudFormFactory.Companion.TITLE
import br.com.astrosoft.transferenciaBancaria.viewmodel.IUsuarioView
import br.com.astrosoft.transferenciaBancaria.viewmodel.UsuarioViewModel
    ...
    return VerticalLayout().apply {
      ...
      formLayout {
        ...
        if (operation in listOf(ADD, READ, DELETE, UPDATE)) {
          ...
          checkBox("Divegencia") {
            binder.bind(this, UserSaci::acl_divergencia.name)
          }
          checkBox("Editor") {
